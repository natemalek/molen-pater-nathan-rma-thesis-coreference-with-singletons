...
class WordVectors:
    def __init__(self, load=False, vectors_file=None, keep_all_words=False):
        vectors_file = vectors_file or directories.PRETRAINED_WORD_VECTORS()
        if load:
    ...
    def write(self, path=None):
        path = path or directories.RELEVANT_VECTORS()
