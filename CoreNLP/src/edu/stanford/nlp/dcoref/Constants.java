...
public class Constants {
  ...
  public static boolean USE_GOLD_SPEAKER_TAGS = false;

  /** if false, use Stanford NER to predict NE labels */
  public static boolean USE_GOLD_NE = false;

  /** if false, use Stanford parse to parse */
  public static boolean USE_GOLD_PARSES = false;

  /** if false, use Stanford tagger to tag */
  public static boolean USE_GOLD_POS = false;
